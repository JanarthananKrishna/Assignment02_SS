...
echo "Software Security Assignment 2";
echo "<br>";
echo"</div>";

echo setHeader("Uploading a file to \"Google Drive\" using \"Google OAuth Access Token\"");
...
<?php if (isset($authUrl)): ?>
  <div class="">
    ...
    <a class='login' href='<?= $authUrl ?>'><img src="google.png" alt="Sign in with Google" title="Sign in with Google"></a>
  </div>
<?php elseif($_SERVER['REQUEST_METHOD'] == 'POST'): ?>
  ...
  <div>
    ...
    <a href='index.php'>Try with diffrent file</a>
  </div>
  <?php }else{ ?>  
  <div>
